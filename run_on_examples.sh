...
opt -dce ~/project/test_codes/Function-inlining/example.0inline.constprop.ll -o ~/project/test_codes/Function-inlining/example.0inline.constprop.dce.ll
opt -dce ~/project/test_codes/Function-inlining/example.1inline.constprop.ll -o ~/project/test_codes/Function-inlining/example.1inline.constprop.dce.ll
opt -dce ~/project/test_codes/Function-inlining/example.2inline.constprop.ll -o ~/project/test_codes/Function-inlining/example.2inline.constprop.dce.ll
opt -dce ~/project/test_codes/Function-inlining/example.3inline.constprop.ll -o ~/project/test_codes/Function-inlining/example.3inline.constprop.dce.ll
opt -dce ~/project/test_codes/Function-inlining/example.4inline.constprop.ll -o ~/project/test_codes/Function-inlining/example.4inline.constprop.dce.ll
opt -dce ~/project/test_codes/Function-inlining/example.5inline.constprop.ll -o ~/project/test_codes/Function-inlining/example.5inline.constprop.dce.ll
