...
opt -dce ~/project/test_codes/Function-inlining/example.0inline.constprop.bc -o ~/project/test_codes/Function-inlining/example.0inline.constprop.dce.bc
opt -dce ~/project/test_codes/Function-inlining/example.1inline.constprop.bc -o ~/project/test_codes/Function-inlining/example.1inline.constprop.dce.bc
opt -dce ~/project/test_codes/Function-inlining/example.2inline.constprop.bc -o ~/project/test_codes/Function-inlining/example.2inline.constprop.dce.bc
opt -dce ~/project/test_codes/Function-inlining/example.3inline.constprop.bc -o ~/project/test_codes/Function-inlining/example.3inline.constprop.dce.bc
opt -dce ~/project/test_codes/Function-inlining/example.4inline.constprop.bc -o ~/project/test_codes/Function-inlining/example.4inline.constprop.dce.bc
opt -dce ~/project/test_codes/Function-inlining/example.5inline.constprop.bc -o ~/project/test_codes/Function-inlining/example.5inline.constprop.dce.bc
