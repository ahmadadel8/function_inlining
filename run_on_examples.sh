...
llvm-dis ~/project/test_codes/Function-inlining/example.0inline.constprob.dce.bc -o ~/project/test_codes/Function-inlining/example.0inline.constprob.dce.ll
llvm-dis ~/project/test_codes/Function-inlining/example.1inline.constprob.dce.bc -o ~/project/test_codes/Function-inlining/example.1inline.constprob.dce.ll
llvm-dis ~/project/test_codes/Function-inlining/example.2inline.constprob.dce.bc -o ~/project/test_codes/Function-inlining/example.2inline.constprob.dce.ll
llvm-dis ~/project/test_codes/Function-inlining/example.3inline.constprob.dce.bc -o ~/project/test_codes/Function-inlining/example.3inline.constprob.dce.ll
llvm-dis ~/project/test_codes/Function-inlining/example.4inline.constprob.dce.bc -o ~/project/test_codes/Function-inlining/example.4inline.constprob.dce.ll
llvm-dis ~/project/test_codes/Function-inlining/example.5inline.constprob.dce.bc -o ~/project/test_codes/Function-inlining/example.5inline.constprob.dce.ll
